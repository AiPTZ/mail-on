# Mail ON — documentacao

Indice do produto.

| Doc | Conteudo |
|---|---|
| `docs/PRODUCT.md` | o que o Mail ON faz, papeis, limites, fluxo do cliente |
| `docs/ARCHITECTURE.md` | tenancy, pipeline de envio, worker, Mailgun, arquivos |
